\message{ !name(econtexSetup.sty)}
\message{ !name(econtexSetup.sty) !offset(-2) }
...
\renewcommand{\handoutM}[1]{\href{https://www.econ2.jhu.edu/people/ccarroll/public/lecturenotes/MathFacts/MathFactsList/}{\texttt{#1}}}
...
\renewcommand{\handoutM}[1]{\href{https://www.econ2.jhu.edu/people/ccarroll/public/lecturenotes/MathFactsList/#1}{\texttt{#1}}}
\fi
...
\message{ !name(econtexSetup.sty) !offset(-246) }
